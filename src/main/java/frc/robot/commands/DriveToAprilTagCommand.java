...
public class DriveToAprilTagCommand extends CommandBase {
  ...
  /** Robotu döndürür ve en iyi (en yakın) alana apriltag sürer*/
  ...
  /** Rotates the robot and drives to a specific apriltag*/
  public DriveToAprilTagCommand(double distanceToTarget, int targetTagID) {
    this(distanceToTarget);
    this.targetTagID = targetTagID; 
  }

  /** Rotates the robot and drives to the best (nearest) target, but instead of specifying distance. only specift target area. */
