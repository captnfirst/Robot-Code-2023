...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    ...
    public double getLeftSpeed() {
      return leftDriveEncoder.getRate() / 1000; // Milimetreden metreye dönüştürmek için 1000 ile bölün
    }
  
    public double getRightSpeed() {
      return rightDriveEncoder.getRate() / 1000; // Milimetreden metreye dönüştürmek için 1000 ile bölün
    }
    ...
    public double getLeftDistance() {
      return leftDriveEncoder.getDistance() / 1000; // Milimetreden metreye dönüştürmek için 1000 ile bölün
    }
    public double getRightDistance() {
      return rightDriveEncoder.getDistance() / 1000; // Milimetreden metreye dönüştürmek için 1000 ile bölün
    }
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Right Drive Encoder", rightDriveEncoder.getRaw()); // Encoder Datasını Shuffleboard aktarma
  }
}
